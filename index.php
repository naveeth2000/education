...
<!--
	...
	Developed By Naveeth Naseer
	
-->
<!DOCTYPE html>
<html lang="zxx">
<head>
<title>HightTech an Education Category Bootstrap Responsive Website Template | Home :: w3layouts</title>
<!-- Meta tag Keywords -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="HighTech web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false);
function hideURLbar(){ window.scrollTo(0,1); } </script>
<!--// Meta tag Keywords -->
<!-- css files -->
<link rel="stylesheet" href="css/bootstrap.css"> <!-- Bootstrap-Core-CSS -->
<link rel="stylesheet" href="css/style.css?v=<?php echo time(); ?>" type="text/css" media="all" /> <!-- Style-CSS --> 
...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="index.html"><i class="fa fa-leanpub" aria-hidden="true"></i> HighTech</a></h1>
			...
			<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
				<nav class="link-effect-2" id="link-effect-2">
					<ul class="nav navbar-nav">
						...
						<li><a href="#team" class="effect-3 scroll">Courses</a></li>
...
<section class="portfolio-w3ls" id="gallery">
		...
		<div class="w3layouts_header">
			<p><i class="fa fa-graduation-cap" aria-hidden="true"></i></p>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g5.jpg" class="swipebox"><img src="images/g.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>HighTech</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g6.jpg" class="swipebox"><img src="images/G5.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>HighTech</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g11.jpg" class="swipebox"><img src="images/G6.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>HighTech</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g8.jpg" class="swipebox"><img src="images/G7.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>HighTech</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
					...
					<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g9.jpg" class="swipebox"><img src="images/G8.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>HighTech</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g10.jpg" class="swipebox"><img src="images/G9.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>HighTech</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g4.jpg" class="swipebox"><img src="images/G10.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>HighTech</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g12.jpg" class="swipebox"><img src="images/G11.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>HighTech</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
...
<div class="team-w3l" id="team">
	<div class="container">
		<h3 class="w3l-title">Our Courses</h3>
		<div class="w3layouts_header">
			<p><i class="fa fa-graduation-cap" aria-hidden="true"></i></p>
		</div>
		<div class="team-w3l-grid">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/ac2.jpg" alt="">
				  <h5>HND in Web Designing</h5>
				  <div class="about_opa">
					<p>This practical course will help build your design</p>
			...
			<div class="col-md-4 col-xs-4 about-poleft t2">
				<div class="about_img"><img src="images/ac3.jpg" alt="">
				  <h5>Master in Web Designing</h5>
				  <div class="about_opa">
					<p>Technical abilities for working on static and dynamic website environments.</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
						<li><a class="fa fa-twitter" href="#"></a></li>
						<li><a class="fa fa-google" href="#"></a></li>
			...
			<div class="col-md-4 col-xs-4 about-poleft t3">
				<div class="about_img"><img src="images/ac4.jpg" alt="">
				  <h5>Wordpress</h5>
				  <div class="about_opa">
		...
		<div class="team-w3l-grid grid-2-team">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/ac1.jpg" alt="">
				  <h5>Diploma Web Designing</h5>
				  <div class="about_opa">
					<p>Traditional classes and online classes</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
						<li><a class="fa fa-twitter" href="#"></a></li>
						<li><a class="fa fa-google" href="#"></a></li>
			...
			<div class="col-md-4 col-xs-4 about-poleft t2">
				<div class="about_img"><img src="images/ac5.jpg" alt="">
				  <h5>BSc in Web Design</h5>
				  <div class="about_opa">
					<p>People with such skills are in short supply</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
						<li><a class="fa fa-twitter" href="#"></a></li>
						<li><a class="fa fa-google" href="#"></a></li>
			...
			<div class="col-md-4 col-xs-4 about-poleft t3">
				<div class="about_img"><img src="images/ac6.jpg" alt="">
				  <h5>Professional Web Design </h5>
				  <div class="about_opa">
					<p>We design this course for your bright future</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
						<li><a class="fa fa-twitter" href="#"></a></li>
						<li><a class="fa fa-google" href="#"></a></li>
...
<!-- contact -->
	...
	$general = $naveeth->general_setting_check();
	if(is_array($general)){
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© <?php echo $general_fetch['website_start']; ?> - 2021 HighTech. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts.</a> Developed By Naveeth Naseer</p>
	</div>
</div>
	<?php } 
	else{ ?>
	...
	<div class="container">
		...
		<div class="agile_banner_bottom_grids">
			...
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right">
					<h4>Phone</h4>
					<p><?php echo "0911234567"; ?> <span><?php echo "Phone"; ?></span></p>
				</div>
			</div>
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				<div class="agile_contact_grid_left agileits_w3layouts_left1">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right1">
					<h4>Email</h4>
					<p><a href="mailto:info@example.com"><?php echo "hightech@gmail.com"; ?></a>
						<span><a href="mailto:info@example.com"><?php echo "hightechcolombo@gmail.com"; ?></a></span></p>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="clearfix"> </div>
		...
		<div class="wthree_footer_grid_left">
			...
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1">
				...
				<ul>
					...
					<li><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="#about" class="scroll">About Us</a></li>
					<li><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="#services" class="scroll">Services</a></li>
					<li><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="#team" class="scroll">Course</a></li>
					<li><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="#gallery" class="scroll">Gallery</a></li>
					<li><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="#mail" class="scroll">Mail Us</a></li>
				</ul>
			</div>
			...
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1 wthree_footer_grid_right1">
				<h4>Contact Us</h4>
				<ul>
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:info@example.com"><?php echo "hightech@gmail.com;"; ?></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i><?php echo "0911234567"; ?></li>
					<li><i class="fa fa-fax" aria-hidden="true"></i><?php echo "Colombo, Srilanka"; ?></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>©   2021 Hightech. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts.</a> Developed By Naveeth Naseer</p>
	</div>
</div>
	<?php }?>
	<!-- //footer -->
