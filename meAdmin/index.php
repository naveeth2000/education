...
$admin_username = mysqli_real_escape_string($naveeth->hackme(),$_POST['admin_username']);
$admin_password = mysqli_real_escape_string($naveeth->hackme(),$_POST['admin_password']);
...
{
$melogin = $naveeth->meadmin_check($admin_username,$admin_password);
if($melogin==1)
{
...
<html>
<head>
<title>HighTech Institute | Login :: w3layouts</title>
				...
				<div class="error_page">
						<!--/login-top-->
							...
							<div class="error-top">
								...
								<div class="login">
									<h3 class="inner-tittle t-inner">HighTech Institute Login</h3>
