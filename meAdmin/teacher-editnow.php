<?php 
 ...
 $edit_teacher_info = $naveeth->edit_teacherid($teacher_id);
...
if(isset($_POST['up_teacher']))
{
	...
	$update_done = $naveeth->update_teacher_info($up_fullname,$up_address,$up_email,$up_father,$up_mother,$up_dob,$up_qualification,$up_contact,$up_staff,$up_gender,$teacher_id);
	if($update_done==true)
	{
		echo "<script>window.location='home.php?naveeth=teacher-information';</script>";
	}
	else
	{
...
<div class="outter-wp">
	...
	<div class="sub-heard-part">
		<ol class="breadcrumb m-b-0">
			...
			<li class="active">
				<?php if(isset($_GET['naveeth'])){ echo strtoupper($page=$_GET['naveeth']); } ?>
			</li>
		</ol>
	</div>
	<!--//sub-heard-part-->
	<div class="graph-visual tables-main">
		<h2 class="inner-tittle">
			<?php echo strtoupper($_GET['naveeth']); ?>
		</h2>
