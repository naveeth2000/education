<?php 
 if(isset($_POST['add_table']))
 {
 	...
 	$Nepdev_add_table_success = $naveeth->menaveeth_add_table($Nepdev_table_Name,$Nepdev_student_name,$Nepdev_student_grade,$Nepdev_subject1,$Nepdev_subject2,$Nepdev_subject3,$Nepdev_subject4,$Nepdev_subject5,$Nepdev_subject6,$Nepdev_subject7,$Nepdev_subject8,$Nepdev_subject9,$Nepdev_subject10,$Nepdev_subject11);
 	if($Nepdev_add_table_success==true)
 	{
 		echo "<script>alert('Success Added $Nepdev_table_Name'); window.location='http://localhost/projects/project2/meadmin/home.php?naveeth=add-table';</script>";
 	}
 	else
 	{
 		echo "<script>alert('Cant Added $Nepdev_table_Name'); window.location='http://localhost/projects/project2/meadmin/home.php?naveeth=add-table';</script>";
 	}
}
if(isset($_POST['add_exam_term']))
{
	$Nepdev_exam_term = $_POST['Nepdev_exam_term'];
	$Nepdev_success_term = $naveeth->Nepdev_Exam_Term($Nepdev_exam_term);
