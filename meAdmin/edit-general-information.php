...
<div class="forms-main">
 ...
 if(isset($_POST['update_general_setting']))
 {
	 ...
	 $upweb_about = $_POST['upweb_about'];
	 	...
	 	$upweb_info_success = $naveeth->general_setting_update($upweb_name,$upweb_address,$upweb_phone1,$upweb_phone2,$upweb_email1,$upweb_email2,$upweb_start,$upweb_about);
	...
	$dis_general_data = $naveeth->general_setting_check();
