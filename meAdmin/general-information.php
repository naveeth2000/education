...
<div class="forms-main">
	...
	$web_info_check = $naveeth->general_setting_check();
			$check_we = $web_info_check->num_rows;
	  if($check_we>0)
	  {
	  	echo "<script>window.location = 'home.php?naveeth=edit-general-information';</script>";
	  }		
			else
			{
 if(isset($_POST['add_general_setting']))
 {
	 ...
	 $web_about = $_POST['web_about'];
	 	...
	 	$web_info_success = $naveeth->general_setting($web_name,$web_address,$web_phone1,$web_phone2,$web_email1,$web_email2,$web_start,$web_about);
