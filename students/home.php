...
else
{
	...
	$st_name = $naveeth->student_info_select($st_username);
...
<head>
	<title>Student Information System | Home :: w3layouts</title>
...
<body>
	<div class="page-container">
									...
									<div class="content tab">
										<section id="section-1">
											<div class="mediabox">
												...
												<p><strong>NIC: </strong>
													<?php echo ucfirst($student_name_display['NIC_no']); ?>
												</p>
											...
											<div class="col-md-12">
												...
												if(isset($_POST['change_password']))
												{
													...
													$st_password_update = $_POST['new_password'];
														$update_success = $naveeth->student_password_change($st_password_update,$st_username);
												...
												<div class="graph">
															<div class="tables">
																...
																<table class="table table-hover"> 
																	...
																	<tbody>
															<?php 
															$teacher_dis_admin = $naveeth->teacher_info_display_admin();
															$s_sn = 1;
		...
		$subject_info_admin = $naveeth->subject_info();
				$sub_sn = 1;
		while($display_subject_admin = $subject_info_admin->fetch_assoc())
		{
		?>					<tr> 
		...
		?>
				...
				<footer>
					<p>&copy 202 Augment . All Rights Reserved | Design by <a href="https://w3layouts.com/" target="_blank">W3layouts.</a> and Develop By Naveeth Naseer</p>
				</footer>
				<!--footer section end-->
			</div>
		</div>
