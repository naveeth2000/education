...
if(isset($_POST['student_signin']))
{
 $st_username = $_POST['st_username'];
	...
	if($st_username=="" || $st_password=="")
	{
	 ...
	 {
	$go = $naveeth->student_login_check($st_username,$st_password);
	if($go==1)
	{
...
<html>
<head>
<title>HigtTech Institute | Login :: w3layouts</title>
								...
								<!--/login-->
									   ...
									   <div class="error_page">
										...
										<div class="footer">
										   ...
										   <p>&copy 2021 Augment . All Rights Reserved | Design by <a href="https://w3layouts.com/" target="_blank">Naveeth Naseer</a></p>
										</div>
									<!--footer section end-->
									<!--/404-->
<!--js -->
